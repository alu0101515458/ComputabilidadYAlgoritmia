...
class State {
  public:
    ...
    std::multimap<Symbol,const State&>::iterator FindTransition(const Symbol& simbolo) const;
    std::multimap<Symbol,const State&> GetTransitions() const;
  ...
  private:
    ...
    std::multimap<Symbol, const State&> transiciones_;
};
